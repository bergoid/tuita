...
define(["vn/lz64i"], function (lz64i) {
...
//    root.console.log("version == " + root.tuita.version);
//    root.console.log("context == " + root.tuita.context);

    ww = new Worker(root.tuita.version + "/ww.js");
    ...
    {
        root.console.log("[Main thread] Error in worker: " + e.message + " (" + e.filename + ":" + e.lineno + ")");
    };
};
