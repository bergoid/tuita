...
ra.configure = function ( options )
{
    settings = ra.extend( options, options || {} );
};
...
ra.crel = function(arg1, arg2, arg3)
{
    ...
    if (arg1)
    {
        ...
        if (ra.isArray(arg1))
        {
            ...
            if (ra.isString(arg1[0]))
                return ra.crel(arg1[0], arg1[1], arg1[2]);
            else
                // if the first element of arg1 is an array too,
                // loop over all elements of arg1 and recurse
                if (ra.isArray(arg1[0]))
                    return arg1.map( function (elem) { return ra.crel(elem); } );
                else
                {
                    ra.error("ra.appendChild(): the argument has an invalid type");
                    return;
                }
        }
            ...
            if (ra.isString(arg1))
            {
                ...
                {
                    ra.error("ra.crel(): failed to create element");
                    return;
                }
            }
            else
                ...
                {
                    ra.error("ra.crel(): invalid arguments");
                    return;
                }
    }
...
ra.append = function(parent, arg1, arg2, arg3)
{
    if (!parent)
    {
        ra.error("ra.appendChild(): no parent");
        return;
    }

    if (!ra.isElement(parent))
    {
        ra.error("ra.appendChild(): parent is not an HTML element");
        return;
    }

    var children = ra.crel(arg1, arg2, arg3);
