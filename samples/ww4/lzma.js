...
define([], function () {
    ...
    var compress = function(str, mode, on_finish, on_progress)
    {
        var this$static = {},
            percent,
            sync = typeof on_finish != "function" && typeof on_progress != "function";

        var onProgress = function(percent)
        {
            typeof on_progress == "function" && on_progress(percent);
        };

        var onFinish = function(res, err)
        {
            typeof on_finish == "function" && on_finish(res, err);
        };
...
//            alert("sync == false");
    ...
    var decompress = function(byte_arr, on_finish, on_progress)
    {
        var this$static = {},
            percent,
            has_progress,
